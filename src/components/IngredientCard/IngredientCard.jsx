...
const IngredientCard = (props) => {
    ...
    return (
        <>
            <div className={`${ingredientCardStyles.card} mt-6 mb-8`} onClick={handleOpenModal}>
                <img className={ingredientCardStyles.cardimage} src={props.item.image} alt={props.item.name}/>
