...
describe("Redux auth store", () => {
    ...
    test('should handle LOGIN_SUCCESS', () => {
        ...
        expect(authReducer(initialState,
            { type: LOGIN_SUCCESS, name: 'Name', token: 'token', email: 'email' })).toEqual(state)
    });
    ...
    test('should handle REGISTRATION_REQUEST', () => {
        ...
        expect(authReducer(initialState, { type: REGISTRATION_REQUEST })).toEqual(state)
    });
    ...
    test('should handle REGISTRATION_SUCCESS', () => {
        ...
        expect(authReducer(initialState, { type: REGISTRATION_SUCCESS, token: 'token', email: 'email', name: 'name' })).toEqual(state)
    });
    ...
    test('should handle REGISTRATION_FAILED', () => {
        ...
        expect(authReducer(initialState, { type: REGISTRATION_FAILED })).toEqual(state)
    });
    ...
    test('should handle GET_USER_REQUEST', () => {
        ...
        expect(authReducer(initialState, { type: GET_USER_REQUEST })).toEqual(state)
    });
    ...
    test('should handle GET_USER_SUCCESS', () => {
        ...
        expect(authReducer(initialState,
            { type: GET_USER_SUCCESS, name: 'name', email: 'email' })).toEqual(state)
    });
    ...
    test('should handle UPDATE_USER_REQUEST', () => {
        ...
        expect(authReducer(initialState, { type: UPDATE_USER_REQUEST })).toEqual(state)
    });
    ...
    test('should handle UPDATE_USER_SUCCESS', () => {
        ...
        expect(authReducer(initialState, { type: UPDATE_USER_SUCCESS, name: 'name', email: 'email' })).toEqual(state)
    });
    ...
    test('should handle UPDATE_USER_FAILED', () => {
        ...
        expect(authReducer(initialState, { type: UPDATE_USER_FAILED })).toEqual(state)
    });
    ...
    test('should handle TOKEN_SUCCESS', () => {
        ...
        expect(authReducer(initialState, { type: TOKEN_SUCCESS, token: 'token' })).toEqual(state)
    });
    ...
    test('should handle RESET_PASSWORD_SUCCESS', () => {
        ...
        expect(authReducer(initialState,
            { type: RESET_PASSWORD_SUCCESS })).toEqual(state)
    });
    ...
    test('should handle SET_PASSWORD_REQUEST', () => {
        ...
        expect(authReducer(initialState, { type: SET_PASSWORD_REQUEST })).toEqual(state)
    });
    ...
    test('should handle SET_PASSWORD_SUCCESS', () => {
        ...
        expect(authReducer(initialState, { type: SET_PASSWORD_SUCCESS, password: 'password' })).toEqual(state)
    });
    ...
    test('should handle SET_PASSWORD_FAILED', () => {
        ...
        expect(authReducer(initialState, { type: SET_PASSWORD_FAILED })).toEqual(state)
    });
