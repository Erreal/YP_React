...
describe('Redux ingredients store', () => {
    ...
    test('should handle GET_ITEMS_REQUEST', () => {
        ...
        expect(ingredientsReducer(initialState, { type: GET_ITEMS_REQUEST })).toEqual(state)
    });
    ...
    test('should handle GET_ITEMS_SUCCESS', () => {
        ...
        expect(ingredientsReducer(initialState, { type: GET_ITEMS_SUCCESS, items: items })).toEqual(state)
    });
    ...
    test('should handle GET_ITEMS_FAILED', () => {
        ...
        expect(ingredientsReducer(initialState, { type: GET_ITEMS_FAILED })).toEqual(state)
    });
    ...
    test('should handle SET_CURRENT_ITEM', () => {
        ...
        expect(ingredientsReducer(initialState, { type: SET_CURRENT_ITEM, item: item })).toEqual(state)
    });
});